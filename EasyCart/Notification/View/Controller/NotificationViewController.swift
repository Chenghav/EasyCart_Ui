...
import UIKit
    ...
    class NotificationViewController: UIViewController, NotificationDemoable {
    ...
    extension NotificationViewController: UITableViewDelegate {
        ...
        func didSelectNotification(_ notification: NotificationModel) {
//               let popUpViewController = UIStoryboard(name: "NotificationSB", bundle: nil).instantiateViewController(withIdentifier: "NotificationPopUpViewController") as! NotificationPopUpViewController
//               popUpViewController.selectedNotification = notification
//            popUpViewController.fullName.text = "hello"
